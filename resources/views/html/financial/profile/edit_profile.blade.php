...
@section('content')
    ...
    <div class="container">
        <a href="{{ route('financial.profile') }}" class="back-btn"><i class="fas fa-arrow-right"></i> العودة إلى الملف
            الشخصي</a>
        ...
        <div class="profile-card">
            ...
            <form id="profileEditForm" action="{{ route('financial.profile.update') }}" method="POST">@csrf
                @method('PUT')
