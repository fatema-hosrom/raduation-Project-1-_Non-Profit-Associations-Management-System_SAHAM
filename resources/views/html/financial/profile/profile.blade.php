...
@push('styles')
    <link rel="stylesheet" href="/assets/css/financial/profile.css">
@endpush

@section('content')

    <div class="container">
        <a href="{{ route('financial.dashboard') }}" class="back-btn"><i class="fas fa-arrow-right"></i> العودة إلى لوحة
            التحكم</a>
        ...
        <div class="profile-card">
            ...
            <div class="profile-info">
                ...
                <div class="info-item">
                    <div class="info-group">
                        <div class="info-label"><i class="fas fa-briefcase"></i><span>نوع المدير</span></div>
                        <div class="info-value">
                            @if ($manager['manager_type'] === 'financial' || $manager->manager_type === 'financial')
                                مدير مالي
                            @else
            ...
            <div class="text-center mt-4">
                <a href="{{ route('financial.profile.edit') }}" class="edit-btn"><i class="fas fa-edit"></i> تعديل الملف
                    الشخصي</a>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    @if (session('success'))
        <script>
            setTimeout(function() {
                var successMessage = document.getElementById('flash-success');
                if (successMessage) {
